...
parser = argparse.ArgumentParser("FingerNet Training with Assistive Center Loss")
...
# dataset
parser.add_argument('-d', '--dataset', type=str, default='dataset', choices=['dataset'])
...
def main():
    ...
    sys.stdout = Logger(osp.join(args.save_dir, 'training_log.txt'))
    ...
    dataset = dataloader.create(
        name='dataset', batch_size=args.batch_size, use_gpu=use_gpu,
    ...
    model = fingernet.create(name='finNet', num_classes=dataset.num_classes)
